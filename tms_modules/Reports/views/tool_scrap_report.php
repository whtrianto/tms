            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    ...
                    <div class="search-section no-print">
                        <h3>Tool Scrap Report</h3>
                        <form method="GET" action="<?= base_url('Reports/tool_scrap_report'); ?>" class="search-form">
                            <label for="scrap_id">SCRAP_ID:</label>
                            <input type="number" 
                                   id="scrap_id" 
                                   name="scrap_id" 
                                   class="form-control" 
                                   value="<?= isset($scrap_id) && $scrap_id > 0 ? (int)$scrap_id : ''; ?>" 
                                   placeholder="Masukkan SCRAP_ID"
                                   required>
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-search"></i> Cari
                            </button>
                            <a href="<?= base_url('Reports/reports/index'); ?>" class="btn btn-secondary">
                                <i class="fa fa-arrow-left"></i> Kembali ke Reports
                            </a>
                        </form>
                    </div>
                    ...
                    <?php if (isset($scrap) && !empty($scrap)): ?>
                        <?php
                        // Format dates
