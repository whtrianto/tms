...
class Tool_draw_engin extends MY_Controller
{
    ...
    /**
     * Halaman detail Tool Drawing Engineering by Product ID (read-only)
     * Digunakan dari index_tool_bom_tooling untuk menampilkan detail Tool Drawing berdasarkan Product ID
     * @param int $product_id
     */
    public function detail_by_product_page($product_id = 0)
    {
        ...
        $row = $this->tool_draw_engin->get_first_by_product_id($product_id);
        ...
        $this->view('detail_tool_draw_engin', $data, FALSE);
    }

    /**
     * Halaman detail Tool Drawing Engineering (read-only)
     * @param int $id
     */
