            ...
            <div class="container-fluid" id="container-wrapper">
                <div class="card mb-3">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <div>
                            <h4 class="m-0 font-weight-bold text-primary">Tool BOM Engineering Detail</h4>
                    ...
                    <div class="card-body">
                        <form id="formBom" method="post" action="#" onsubmit="return false;">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label>Tool BOM</label>
                                    <input type="text" class="form-control" name="TOOL_BOM" readonly value="<?= htmlspecialchars($bom['TOOL_BOM']); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" class="form-control" name="REVISION" readonly value="<?= htmlspecialchars(isset($bom['REVISION']) ? $bom['REVISION'] : 0); ?>">
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Process</label>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="DESCRIPTION" readonly value="<?= htmlspecialchars(isset($bom['DESCRIPTION']) ? $bom['DESCRIPTION'] : ''); ?>">
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    ?>
                                    <input type="text" class="form-control" readonly value="<?= htmlspecialchars($statusText); ?>">
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    ?>
                                    <input type="text" class="form-control" readonly value="<?= htmlspecialchars($eff); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="CHANGE_SUMMARY" rows="3" class="form-control" readonly><?= htmlspecialchars(isset($bom['CHANGE_SUMMARY']) ? $bom['CHANGE_SUMMARY'] : ''); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <?php if (!empty($bom['DRAWING'])): ?>
                                        <div class="form-control" style="background-color: #e9ecef; padding: 0.375rem 0.75rem;">
                                            <?= htmlspecialchars($bom['DRAWING']); ?>
                                        </div>
                                    <?php else: ?>
                                        <div class="form-control" style="background-color: #e9ecef; padding: 0.375rem 0.75rem; color: #6c757d;">
                                            No drawing file
                                        </div>
                                    <?php endif; ?>
                                </div>
