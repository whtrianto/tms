                                ...
                                <div class="col-md-6">
                                    <div class="detail-row">
                                        ...
                                        <span class="detail-value">
                                            <?php if (!empty($drawing_file)): ?>
                                                <?php
                                                $mlr_id = isset($drawing['MLR_ID']) ? (int)$drawing['MLR_ID'] : 0;
                                                $mlr_rev = isset($drawing['MLR_REV']) ? (int)$drawing['MLR_REV'] : 0;
                                                $drawing_file_escaped = htmlspecialchars($drawing_file, ENT_QUOTES, 'UTF-8');
                                                $download_url = base_url('Tool_engineering/tool_draw_engin/serve_file_by_mlr?mlr_id=' . $mlr_id . '&mlr_rev=' . $mlr_rev . '&type=drawing');
                                                ?>
                                                <a href="<?= $download_url; ?>" download="<?= $drawing_file_escaped; ?>" class="text-primary" style="text-decoration: underline; cursor: pointer; display: inline-block; padding: 4px 8px; border: 1px solid #ccc; background: #fff; border-radius: 4px;"
                                                    onmouseover="this.style.background='#f0f0f0';"
                                                    onmouseout="this.style.background='#fff';"
                                                    title="Klik untuk download file">
                                                    <i class="fa fa-download"></i> <?= $drawing_file_escaped; ?>
                                                </a>
                                            <?php else: ?>
                                                <?= htmlspecialchars($drawing_file, ENT_QUOTES, 'UTF-8'); ?>
                                            <?php endif; ?>
                                        </span>
                                    </div>
                                    <div class="detail-row">
